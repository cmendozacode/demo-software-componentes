...
@Component({
    selector: 'yp-legalcompany',
    templateUrl: './legalcompany.component.html',
    styleUrls: []
  })
  export class LegalcompanyComponent implements OnInit{
    ...
    ngOnInit(){
        ...
        this.tableSearchBox = [
            {"propertyName":"code" ,"fieldFormName":"pvname" , "controlClass":"cssinputform", "controlType":"label" ,"controlSubType": "text"  ,  "propertyTextLabel":"txtcode" , "propertyTextHolder" : "txtcode", "visible":true , "required":true , "readonly":false,"searchflag":true, "maxlength": 15, "fieldWidth":"150px"},
            {"propertyName":"name"  ,"fieldFormName":"pvfullname" , "controlClass":"cssinputform", "controlType":"label" ,"controlSubType": "text"  ,  "propertyTextLabel":"txtname" , "propertyTextHolder" : "txtname", "visible":true , "required":true , "readonly":false,"searchflag":true, "maxlength": 15, "fieldWidth":"350px"},
        ...
        this.newEditform =[
            ...
            "groupConfig":[
                   {"propertyName":"company_number"  ,"fieldFormName":"pvcompanynumber" , "controlClass":"cssinputform", "controlType":"input"     ,"controlSubType": "text"   , "propertyTextHolder" : "txttaxnumber",  "propertyTextLabel":"txttaxnumber", "visible":true , "required":false , "readonly":false, "fieldWidth":"200px"},
                   {"propertyName":"legal_name"  ,"fieldFormName":"pvlegalrazon" , "controlClass":"cssinputform", "controlType":"input"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtlegalname",  "propertyTextLabel":"txtlegalname", "visible":true , "required":false , "readonly":false, "fieldWidth":"400px"}
                         ]
            }
            ,
            {"groupFields":"row4" , "controlClass":"cssgroupform",
            "groupConfig":[
                   {"propertyName":"country"  ,"fieldFormName":"pvcountry" , "controlClass":"cssinputform", "controlType":"input"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtcountry",  "propertyTextLabel":"txtcountry", "visible":true , "required":false , "readonly":false, "fieldWidth":"200px"},
                   {"propertyName":"city"  ,"fieldFormName":"pvcity" , "controlClass":"cssinputform", "controlType":"input"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtcity",  "propertyTextLabel":"txtcity", "visible":true , "required":false , "readonly":false, "fieldWidth":"200px"}
                         ]
            }
            ,
            {"groupFields":"row5" , "controlClass":"cssgroupform",
            "groupConfig":[
                   {"propertyName":"fiscal_address"  ,"fieldFormName":"pvfiscaladdress" , "controlClass":"cssinputform", "controlType":"input"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtaddress",  "propertyTextLabel":"txtaddress", "visible":true , "required":false , "readonly":false, "fieldWidth":"450px"}
                         ]
            }            
            ,
            ...
            ,
            {"groupFields":"row7" , "controlClass":"cssgroupform",
            "groupConfig":[
           ...
           "groupConfig":[
              {"propertyName":"objlabel" ,"fieldFormName":"pvlabel" , "controlClass":"csstextform", "controlType":"text" ,"controlSubType": "h5" ,  "propertyTextLabel":"txt_h_fieldconfig_title", "visible":true , "required":true , "readonly":false,  "fieldWidth":"250px"},
            ]
           }
           ,
            {"groupFields":"row4" , "controlClass":"cssgroupform",
            "groupConfig":[
                   {"propertyName":"attribute1"  ,"fieldFormName":"pvattribute1" , "controlClass":"cssinputform", "controlType":"input"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtfieldconfig",  "propertyTextLabel":"txtfieldconfig", "visible":true , "required":false , "readonly":false, "fieldWidth":"250px"}
            ...
            {"groupFields":"row4" , "controlClass":"cssgroupform",
            "groupConfig":[
                   {"propertyName":"id"  ,"fieldFormName":"pvid" , "controlClass":"cssinputform", "controlType":"hidden"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtfieldconfig",  "propertyTextLabel":"txtfieldconfig", "visible":false , "required":false , "readonly":false, "fieldWidth":"250px"},
                   {"propertyName":"company_id"  ,"fieldFormName":"pvrepeat_passowrd" , "controlClass":"cssinputform", "controlType":"hidden"     ,"controlSubType": "text"   , "propertyTextHolder" : "txtfieldconfig",  "propertyTextLabel":"txtfieldconfig", "visible":false , "required":false , "readonly":false, "fieldWidth":"250px"}
                         ]
            }
...
fn_Consultar(){
   ...
   var objHeader = this.objHttpRequestHeader;
    ...
    this.securitySrv.getLegalCompany(objBody,objHeader).then(
    (response) => {
  ...
  fn_save_new(objBody, objHeader){
    ...
    this.securitySrv.saveLegalCompany(objBody,objHeader,'POST').then(
        (response) => {
 ...
 fn_save_updated(objBody, objHeader){
    ...
    for (const key in sourceData) {
        if( (sourceData[key] != null && sourceData[key] != undefined) 
         || ( key in {'start_date':1,'end_date':1,'code':1,'name':1,'company_number':1,'legal_name':1}  ) )
    ...
    this.securitySrv.saveLegalCompany(objBody,objHeader,'PUT').then(
        (response) => {
