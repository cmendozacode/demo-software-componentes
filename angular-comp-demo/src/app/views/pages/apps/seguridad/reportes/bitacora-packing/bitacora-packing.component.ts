...
@Component({
  selector: 'kt-bitacora-packing',
  templateUrl: './bitacora-packing.component.html',
  styleUrls: ['./bitacora-packing.component.scss']
})
export class BitacoraPackingComponent implements OnInit {
  ...
  consultarReporte() {
    if(!this.filterForm.invalid){
      ...
      this.afAuth.authState.subscribe(user=>{
        this.firestorSeguridadService.getBitacoraCambioHoras("incidencia_horas_tareopacking",this.filterBusqueda(this.filterForm)).subscribe(
          result => {
  ...
  getTituloReporte():string {
    return "Bitácora de manipulación de horas - Tareo Packing";
  }
