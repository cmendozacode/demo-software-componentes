...
import { ActionNotificationComponent,
	...
	QuestionCommentDialogComponent,
...
export class LayoutUtilsService {
	 ...
	 */
	deleteElement(title: string = '', description: string = '', waitDesciption: string = '',data:any=null,actionModal:any=null) {
		return this.dialog.open(DeleteEntityDialogComponent, {
			data: { title, description, waitDesciption, data, actionModal},
			width: '440px'
		});
	}

	/**
	 * Showing Confirmation (Mat-Dialog) before Action
	 *
	 * @param title: stirng
	 * @param description: stirng
	 * @param waitDesciption: string
	 */
	confirmActionElement(title: string = '', description: string = '') {
	...
	questionElement(title: string = '', description: string = '', waitDesciption: string = '') {
		return this.dialog.open(QuestionEntityDialogComponent, {
			data: { title, description, waitDesciption },
			width: '440px'
		});
	}

	quetionCommentElement(title: string = '', description: string = '') {
		return this.dialog.open(QuestionCommentDialogComponent, {
			data: { title,description},
			width: '440px'
		});
	}
	...
	showNotificationElement(title: string = '', description: string = '') {
		return this.dialog.open(ShowNotificationDialogComponent, {
			data: { title,description},
			width: '350px'
		});
	}
