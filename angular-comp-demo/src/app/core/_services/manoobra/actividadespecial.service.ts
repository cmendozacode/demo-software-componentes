...
export class ActividadEspecialService {

  private readonly baseUrl:string = environment.api + 'actividadespecial';
  ...
  public eliminarRegistro$ = (datos:ActividadCecoModel):Observable<any> => this.httpClient.put(this.baseUrl + '/2', datos, {headers: this.headers});
