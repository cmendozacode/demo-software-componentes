...
import { UsuarioModel } from '../../_models';
...
export class UsuarioService {
    ...
    private readonly baseUrl:string = environment.api + 'usuario';
    ...
    public insertarRegistro$ = (datos:UsuarioModel):Observable<any> => this.httpClient.post(this.baseUrl, datos, {headers: this.headers});
    public actualizarRegistro$ = (datos:UsuarioModel):Observable<any> => this.httpClient.put(this.baseUrl + '/2', datos, {headers: this.headers});
    public eliminarRegistro$ = (datos:UsuarioModel):Observable<any> => this.httpClient.put(this.baseUrl + '/3', datos, {headers: this.headers});
