...
export class ProveedorService {
  private readonly baseUrl: string = environment.api + 'ctrltruck/proveedor';
  ...
  public gestionUsuarios$ = (datos: any): Observable<any> =>
    this.httpClient.post(this.baseUrl + '/gestionUsuarios', datos, { headers: this.headers })
}
