...
export class CamionService {
  private readonly baseUrl: string = environment.api + 'ctrltruck/camion';
  ...
  public eliminarRegistroMasivo$ = (datos: any): Observable<any> =>
	...
	public gestionTarifas$ = (datos: any): Observable<any> =>
    this.httpClient.post(this.baseUrl + '/gestionTarifas', datos, { headers: this.headers })
}
