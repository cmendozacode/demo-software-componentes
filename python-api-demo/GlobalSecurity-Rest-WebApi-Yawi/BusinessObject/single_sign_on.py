...
class SingleSignOnBO():
    
    def __init__(self):
        super(SingleSignOnBO,self).__init__()
        
        self.objDataSysStructure = system_data_structures()
    
    
    def fn_get_software_auth_sql(self,object_body,  str_login_object_name: Optional[str] = None):
        ...
        if str_connection is not None:
            ...
            #Generate Token
            object_data_connector = GenericObjectBO(self.str_login_object_name,self.str_connection)
